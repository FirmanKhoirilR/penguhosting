...
const Testimonial = () => {
  return (
    <div className="w-full bg-black/40 text-white px-2 md:px-4 min-h-[50vh] pb-14 pt-28">
      ...
      <div className=" flex  mt-10 relative overflow-x-auto scrollbar scrollbar-none scr w-full text-black gap-4 p-2 md:p-4">
        {testimonial.map((item: TTestimonial, i: number) => (
          <div key={i} className="p-4 rounded-sm flex select-none flex-col justify-between bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] mb-6 lg:mb-0 min-w-[350px] min-h-[300px]">
            <div>
