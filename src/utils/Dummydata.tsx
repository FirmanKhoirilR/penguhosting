...
import { AiOutlineInstagram, AiFillYoutube, AiOutlineTwitter, AiFillCloseCircle } from "react-icons/ai";
import { Games, Hosting, Vpn, Roket, Hero, Pengu, Samsungpro, amd, Samsungetc } from "../assets";
...
export const footerLink = [
  ...
  },
  {
    ...
    link: [
      { name: "blog", href: "/blog" },
      { name: "rechenzentrum", href: "/gamemaster" },
      { name: "DDoS Schutz", href: "/gamemaster" },
      { name: "Hardware und Technik", href: "/gamemaster" },
      { name: "Ceph Cluster", href: "/gamemaster" },
    ],
  },
  {
    title: "infrastruktur",
    link: [
      { name: "status", href: "/gamemaster" },
      { name: "smokeping", href: "/gamemaster" },
    ],
  },
  {
    title: "Rechtliches",
